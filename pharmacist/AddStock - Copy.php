...
$content = "<h2 style='text-align:center;'>Add New Stock</h2>
    <form name='myForm' id='myForm' action='AddStock.php' method ='post' autocomplete='off' onsubmit='return validateForm()'>
      ...
      <fieldset>
        <table>
              <tr style='height:50px;'>
                ...
                <td>
                <input type ='text' id='txtMedicineName' name='txtMedicineName' class='inputField' name ='txtMedicineName' autocomplete='off'>
                </td>
                <td>
       ...
       <tr  style='height:50px;'> 
        ...
        <tr style='height:50px;'>
            ...
            <td>
            <input type='date' id='EXP_date' class='inputField' name='EXP_date' /><br/>
            </td>
        </tr>
        <tr style='height:50px;'>
        <td>
